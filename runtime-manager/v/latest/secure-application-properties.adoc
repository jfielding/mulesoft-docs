...
. Identify the property names that you wish to secure in your `mule-app.properties` file by listing them as `secure.properties`. In the example below, there are four total properties used in the application, which have been defined in the mule-app.properties file. Line 3 flags two of the properties as secure. 
+
.mule-app.properties
[source,json, linenums]
----
1. http.port=8081
2. birthdate=01/01/2015
3. secure.properties=password, birthdate
----
+
